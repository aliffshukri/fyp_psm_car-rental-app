        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTerm("4.", "The customer is responsible for paying all summonses, compounds, or fines throughout the rental period."),
              _buildTerm("5.", "The customer is responsible for ensuring that the car is always in good condition and clean throughout the rental period until the vehicle is returned. Borrowers are absolutely FORBIDDEN to spit, smoke or litter in the car. If it is found that the exterior and interior of the car are very dirty such as spilled water or food on the car dashboard, door panels or cushions, and there is an unpleasant smell or there is any damage, the CUSTOMER will be charged an ADDITIONAL CHARGE for cleaning and all the costs of restoring the vehicle to condition original."),
              _buildTerm("6.", "The customer rental car will be tracked during rental period by the staff for safety reasons."),
              _buildTerm("7.", "If an accident occurs, the CUSTOMER must inform us as soon as possible and not take any other action before that to avoid problems between the borrower and us in the future."),
            ],
          ),
        ),
      ),
